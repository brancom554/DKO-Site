<?php
if(!isset($_SERVER[ 'APPLICATION_ENV' ])) DEFINE('_INSTANCE', 'JISDEV'); // Local Test
...
// $dbconnect=mysqli_connect($iniObj->DbHost,$iniObj->DbUser,$iniObj->DbPass,$iniObj->DbName);
...
// phpinfo();
// exit;
// echo "end config.path";
// $lib->debug($_db);
// $lib->debug($iniObj);
// echo "dbname : ".$_db->DbName;
// exit;
/* setting the language for current session */
// if($lib->lang!=$lang_requested)
//	echo "lang config=>";
//	$lib->debug($lang);
// $lib->lang=$_SESSION['LANG']=$lang_requested;
